...
// NUEVO: flags para admin
let ES_ADMIN = false;
let ID_USUARIO_PACIENTE = 0;

document.addEventListener("DOMContentLoaded", function (event) {

    // Leer hidden de la vista
    ES_ADMIN = $("#hdnEsAdmin").val() === "1";
    ID_USUARIO_PACIENTE = parseInt($("#hdnIdUsuarioPaciente").val() || "0");

    console.log("NuevaCita.js cargado. ES_ADMIN =", ES_ADMIN, "ID_USUARIO_PACIENTE =", ID_USUARIO_PACIENTE);
...
$("#btnAgendar").on("click", function () {
    ...
    // Estos campos son opcionales; si no existen en la vista, no pasa nada
    ...
    const construirYEnviar = function (fileBase64, contentType) {
        ...
        // Si es admin y tenemos un paciente seleccionado, lo enviamos
